...
class _PokemonCardViewState extends State<PokemonCardView> {
          ...
          Container(
            ...
            child: Container(
              margin: EdgeInsets.fromLTRB(
                  0, 0, 0, MediaQuery.of(context).size.height - 200),
              decoration: BoxDecoration(color: Color.fromARGB(152, 0, 0, 0)),
              child: Text(
  ...
  FutureBuilder<List<dynamic>> PokemonGameView() {
